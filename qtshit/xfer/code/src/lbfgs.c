/* lbfgs.f -- translated by f2c (version 20041007).
	...
	csave_len)
{
    ...
    extern /* Subroutine */ int formk_(integer *, 
	...
	doublereal *wn, integer *iprint, integer *info)
{
    ...
    static cilist io___242 = { 0, 6, 0, fmt_1002, 0 };
    static cilist io___243 = { 0, 6, 0, 0, 0 };
    static cilist io___244 = { 0, 6, 0, fmt_1003, 0 };
